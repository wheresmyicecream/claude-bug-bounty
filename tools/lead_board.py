...
ROUTES = [
    ...
    (R(r"reset|forgot|recover|/verify|/otp|\b2fa\b|/mfa|change.?email|change.?phone|change.?password", re.I),
     "url", "hunt-ato", P_HIGH, "account-recovery flow", "ATO via reset/OTP/email-change weakness"),
    (R(r"\botp\b|\b2fa\b|/mfa|totp|authenticator|verify.?code", re.I),
